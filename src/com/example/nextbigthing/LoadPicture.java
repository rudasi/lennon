...
public class LoadPicture extends Activity  {
	...
	private static final int ACTION_NEW_POST = 1;
	private static final int ACTION_LOGOUT_APP = 2;
	// GestureDetector gesturedetector = null;
	//OnSwipeTouchListener swipe = null;
	View layout;
	
	private void dispatchNewPostIntent(int actionCode){
		if (actionCode == ACTION_NEW_POST){
			Intent new_post = new Intent(this, PictureCapture.class);
			startActivityForResult(new_post, ACTION_NEW_POST);
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button newPostBtn = (Button) findViewById(R.id.btnNewPost);
		newPostBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				dispatchNewPostIntent(ACTION_NEW_POST);
			}
		});
