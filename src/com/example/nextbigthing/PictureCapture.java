...
public class PictureCapture extends Activity {
	...
	private static final String IMAGEVIEW_VISIBILITY_STORAGE_KEY2 = "imageviewvisibility2";
	...
	protected void onSaveInstanceState(Bundle outState) {
		outState.putParcelable(BITMAP_STORAGE_KEY1, mImageBitmap1);
		outState.putBoolean(IMAGEVIEW_VISIBILITY_STORAGE_KEY1, (mImageBitmap1 != null));
		outState.putParcelable(BITMAP_STORAGE_KEY2, mImageBitmap2);
		outState.putBoolean(IMAGEVIEW_VISIBILITY_STORAGE_KEY2, (mImageBitmap2 != null));
	...
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
		...
		mImageBitmap1 = savedInstanceState.getParcelable(BITMAP_STORAGE_KEY1);
		mImageView1.setImageBitmap(mImageBitmap1);
		mImageView1.setVisibility(
			savedInstanceState.getBoolean(IMAGEVIEW_VISIBILITY_STORAGE_KEY1) ?
					ImageView.VISIBLE : ImageView.INVISIBLE
		);
		
		mImageBitmap2 = savedInstanceState.getParcelable(BITMAP_STORAGE_KEY2);
		mImageView2.setImageBitmap(mImageBitmap2);
		mImageView2.setVisibility(
			savedInstanceState.getBoolean(IMAGEVIEW_VISIBILITY_STORAGE_KEY2) ?
					ImageView.VISIBLE : ImageView.INVISIBLE
		);
